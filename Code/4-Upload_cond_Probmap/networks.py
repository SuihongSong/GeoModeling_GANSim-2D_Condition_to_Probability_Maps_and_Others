...
def G_paper(
    ...
    **kwargs):                          # Ignore unrecognized keyword args.
    ...
    if labels_augment: labels_in = labels_augment_func(labels_in, label_size, labels_augment_times)
    ...
    if structure == 'recursive':
        def grow(x, prob, res, lod):
            ...
            if lod > 0: img = cset(img, (lod_in < lod), lambda: grow(y, prob, res + 1, lod - 1))
            return img()
